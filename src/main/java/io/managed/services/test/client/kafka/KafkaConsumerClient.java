...
public class KafkaConsumerClient {
    ...
    public static Future<List<KafkaConsumer<String, String>>> createNConsumers(
        Vertx vertx, int n, String topic, String bootstrapHost, String clientID, String clientSecret, String groupID) {
        ...
        for (int i = 0; i < n; i++) {
            KafkaConsumer<String, String> consumer = KafkaConsumerClient.createConsumer(
                vertx, bootstrapHost, clientID, clientSecret, KafkaAuthMethod.OAUTH, groupID, "earliest");
